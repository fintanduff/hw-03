...
# gss16_advfront <- read.csv("path_to_your_data_file")

# Fit linear regression model
model <- lm(emailhr ~ educ, data = gss16_advfront)

# Summary of the regression model
summary(model)

# Accessing coefficients of the regression model
coefficients(model)

# Plotting the line of best fit
plot(gss16_advfront$educ, gss16_advfront$emailhr, 
     xlab = "Education Level", ylab = "Email Hours",
     main = "Linear Regression: Email Hours based on Education Level")
